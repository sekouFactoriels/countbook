...
<div class="panel panel-default">
  <div class="panel-heading">
    ...
    <small class="panel-title"><i class="glyphicon glyphicon-liste"></i>&nbsp;<?= Yii::t('app','invent_produit')?>  : Filtre</small>
  </div>
        ...
        <div class="panel-footer">
          <div class="row">
            <div class="col-sm-9 col-sm-offset-3">
              <a class="btn btn-circle btn-success" href="javascript:;" onclick="document.getElementById('action_key').value='<?= md5('rg_invent_analysearticle')?>'; document.getElementById('action_on_this').value='<?= md5('rg_invent_analysearticle_repport')?>'; document.getElementById('rg_invent_listarticle').submit()"><i class="fa fa-eye"></i>&nbsp;Afficher</a>
              <span>&nbsp;</span>
