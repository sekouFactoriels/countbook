...
<div class="panel panel-default">
  <div class="panel-heading">
    <div class="panel-btns">
      <a href="javascript:;" onclick="document.getElementById('action_key').value='<?= md5('1')?>'; document.getElementById('rg_invent_articlealertstok').submit()" style="color: #000;" class="btn btn-circle btn-white" name="retour" id="retour"> <i class="fa fa-backward">&nbsp;</i>Retour</a>
    </div>
    <small class="panel-title"><i class="glyphicon glyphicon-liste"></i>&nbsp;<?= Yii::t('app','produit_court_stock')?>  : Filtre</small>
  </div>

  <form class="form-horizontal" action="<?= Yii::$app->request->baseUrl.'/'.md5("rg_invent")?>" id="rg_invent_articlealertstok" name="rg_invent_articlealertstok" method="post">
    <!-- DEBUT PANEL BODY -->
    <div class="panel-body">
      ...
      <fieldset>
        <legend> <h4>Filtrer par categorie de produits</h4></legend>
      </fieldset>
        ...
        <fieldset>
        <legend> <h4>Filtrer par Service</h4></legend>
      </fieldset>
        ...
        <div class="panel-footer">
          <div class="row">
            <div class="col-sm-9 col-sm-offset-3">
              <a class="btn btn-circle btn-success" href="javascript:;" onclick="document.getElementById('action_key').value='<?= md5('rg_invent_articlealertstok')?>'; document.getElementById('action_on_this').value='<?= md5('rg_invent_articlealertstok_repport')?>'; document.getElementById('rg_invent_articlealertstok').submit()"><i class="fa fa-eye"></i>&nbsp;Afficher</a>
              <span>&nbsp;</span>
              <a type="reset" href="javascript:;" onclick="document.getElementById('action_key').value='<?= md5('1')?>'; document.getElementById('rg_invent_articlealertstok').submit()" class="btn btn-circle btn-warning"><i class="glyphicon glyphicon-remove-circle"></i>&nbsp;Anuler</a>
            </div>
          </div>
        </div>
