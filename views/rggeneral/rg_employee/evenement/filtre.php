        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6 input-group">
              <input class="form-control datepicker" id="datefrom" name="datefrom" value="<?= (is_array($dataposted) && sizeof($dataposted) > 0) ? $dataposted['datefrom'] : ''?>">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6 input-group">
              <input class="form-control datepicker" id="dateto" name="dateto" value="<?= (is_array($dataposted) && sizeof($dataposted) > 0) ? $dataposted['dateto'] : ''?>">
              <span class="input-group-addon hidden-md hidden-lg"></span>
            </div>
          </div>
        </div>
