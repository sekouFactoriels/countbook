...
<div class="panel panel-default">
  ...
  <form action="<?= Yii::$app->request->baseUrl . '/' . md5("parametre_newentreprise") ?>" class="form-horizontal" id="entreprise_form" name="entreprise_form" method="post" enctype="multipart/form-data">
    <div class="panel-body">
      ...
      <!-- Gnrl_field -->
      <?php 
        require_once 'newentreprise_components/_gnrl_field.php';
      ?>
      <!-- // Gnrl_field // -->
      ...
      <!-- Souscription -->
      <?php 
        require_once 'newentreprise_components/_suscription_fied.php';
      ?>
      <!-- // Souscription // -->
      ...
      <div class="form-group" id="div_filiale" style="display: none;">
        <?php 
          require_once 'newentreprise_components/_branch_field.php';
        ?>
      </div>
      <!-- // Branche // -->
      ...
      <!-- Renseignement Proprietaire -->
      <?php 
        require_once 'newentreprise_components/_owner_account.php';
      ?>
      <!-- End : Renseignement Proprietaire -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="javascript:;" type="button" onClick="document.getElementById('action_key').value='<?= md5("newentreprise_saveentreprise") ?>'; $('#entreprise_form').submit();" class="btn btn-circle btn-success"><i class="glyphicon glyphicon-saved"></i>&nbsp;<?= Yii::t('app', 'oui') ?></a>
