...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <h4 class="panel-title"><i class="fa fa-building-o">&nbsp;</i><?= yii::t('app', 'parametre_entreprise') ?>&nbsp;:&nbsp;Nouvelle Branche&nbsp;</h4>
    </div>
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4 input-group">
                    <input class="col-sm-4 form-control" autocomplete="off" name="nomBranche" id="nomBranche" value="" /> <span class="input-group-addon hidden-md hidden-lg"></span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4 input-group">
                <input class="col-sm-4 form-control" autocomplete="off" name="telBranche" id="telBranche" value="" /> <span class="input-group-addon hidden-md hidden-lg"></span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4 input-group">
                <input class="col-sm-4 form-control" autocomplete="off" name="emailBranche" id="emailBranche" value="" /><span class="input-group-addon hidden-md hidden-lg"></span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4 input-group">
                <input class="col-sm-4 form-control" autocomplete="off" name="descriptionBranche" id="descriptionBranche" value="" /><span class="input-group-addon hidden-md hidden-lg"></span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4 input-group">
                <textarea class="col-sm-4 form-control" name="adresseBranche" id="adresseBranche"></textarea><span class="input-group-addon hidden-md hidden-lg"></span>
                </div>
            </div>
            <!-- DEBUT : FOOTER -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="javascript:;" type="button" onClick="document.getElementById('action_key').value='<?= md5("new_branche") ?>'; $('#countbook_form').submit();" class="btn btn-circle btn-success"><i class="glyphicon glyphicon-saved"></i>&nbsp;<?= Yii::t('app', 'oui') ?></a>
