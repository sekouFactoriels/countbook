  ...
  <form class="form-horizontal" action="<?= Yii::$app->request->baseUrl.'/'.md5("client_spaceclient")?>" id="editclient_form" name="editclient_form" method="POST">
    ...
    <div class="panel-body">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-4 input-group">
          <select name="statutClient" id="statutClient" class="form-control chosen-select">
            <option value="0" <?= ($statutClient == '0') ? 'selected' : ''?>>>--<?= Yii::t('app','slectOne') ?>--<</option>
            <option value="1" <?= ($statutClient == '1') ? 'selected' : ''?>><?= Yii::t('app','particulier') ?></option>
            <option value="2" <?= ($statutClient == '2') ? 'selected' : ''?>><?= Yii::t('app','entreprise') ?></option>
          </select>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-4 input-group">
          <select name="segmentClient" id="segmentClient" class="form-control chosen-select">
            <option value="0" <?= ($segmentClient == '0') ? 'selected' : ''?> >>-- <?= Yii::t('app','slectOne') ?> --<</option>
            <option value="1" <?= ($segmentClient == '1') ? 'selected' : ''?> ><?= Yii::t('app','prospect_froid') ?></option>
            <option value="2" <?= ($segmentClient == '2') ? 'selected' : ''?> ><?= Yii::t('app','prospect_tiede') ?></option>
            <option value="3" <?= ($segmentClient == '3') ? 'selected' : ''?> ><?= Yii::t('app','prospect_chaud') ?></option>
            <option value="4" <?= ($segmentClient == '4') ? 'selected' : ''?> ><?= Yii::t('app','client') ?></option>
          </select>
          <span class="input-group-addon hidden-md hidden-lg"></span>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-4 input-group">
          <input class="form-control" autocomplete="off" name="appelation" id="appelation" value="<?= isset($_POST['appelation']) ? $_POST['appelation'] : (isset($dtlContact['nom_appellation']) ? $dtlContact['nom_appellation'] : '') ?>"/>
          <span class="input-group-addon hidden-md hidden-lg"></span>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-4 input-group">
          <input type="text" data-provide="datepicker" autocomplete="off" value="<?= isset($dayBirth) ? $monthBirth.'/'.$dayBirth.'/'.$yearBirth : (isset($dtlContact['nom_appellation']) ? $dtlContact['monthBirth'].'/'.$dtlContact['dayBirth'].'/'.$dtlContact['yearBirth'] : '') ?>" class="form-control datepicker" placeholder="dd/mm/yyyy" id="dtebirth" name="dtebirth">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-4 input-group">
          <input class="form-control" name="tel" autocomplete="off" placeholder="Ex : 224624123456" id="tel" value="<?= isset($_POST['tel']) ? $_POST['tel'] : (isset($dtlContact['tel1']) ? $dtlContact['tel1'] : '') ?>"/>
          <span class="input-group-addon hidden-md hidden-lg"></span>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-4 input-group">
          <input class="form-control" name="email" placeholder="Ex : test@test.com"  autocomplete="off" id="email" value="<?= isset($_POST['email']) ? $_POST['email'] : (isset($dtlContact['email']) ? $dtlContact['email'] : '') ?>"/>
          <span class="input-group-addon hidden-md hidden-lg"></span>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-4 input-group">
          <textarea class="form-control" rows="3" name="dtlsmotif" id="dtlsmotif"><?= isset($_POST['dtlsmotif']) ? $_POST['dtlsmotif'] : (isset($dtlContact['dtlsMotif']) ? $dtlContact['dtlsMotif'] : '') ?></textarea>
          <span class="input-group-addon hidden-md hidden-lg"></span>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-4 input-group">
          <select name="statut" id="statut" class="form-control chosen-select">
            <option value="0">>-- <?= Yii::t('app','slectOne') ?> --<</option>
