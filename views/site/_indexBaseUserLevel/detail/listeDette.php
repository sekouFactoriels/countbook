<form action="<?= yii::$app->request->baseurl . '/' . md5('vente_simple') ?>" id="detailvendu" name="detailvendu" method="post">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <h4 class="panel-title"><i class="fa fa-list">&nbsp;</i>Liste des Dettes du Mois</h4>
        </div>
                            ...
                            foreach ($bills as $key => $each_bill) {
                                ...
                                if ($dette > 0) {
                                    ...
                                    echo '
                                            ...
                                            <td style="font-size: 16px; font-weight: bold;">' . Yii::$app->venteClass->getFournisseurName($each_bill["autre_partie_id"]) . '</td>
