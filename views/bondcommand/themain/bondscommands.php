      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <div class="panel-btns">
            <a href="javascript:;" onclick="$('#action_key').val('<?= md5("nvente")?>'); $('#listeventes').submit();" style="color: #000;" class="btn btn-circle btn-white" name="lbl_listeventes"> <i class="fa fa-plus">&nbsp;</i><?= Yii::t('app','newProductLabel')?></a>
          </div>
          <h4 class="panel-title"><i class="fa fa-list">&nbsp;</i>Liste des ventes</h4>
        </div>
                ...
                <?php
                  if(is_array($ventesDtls) && sizeof($ventesDtls) > 0){
                    foreach ($ventesDtls as $key => $data) {
                      ...
                      <?php
                      }else{$recouvrementBtn = '<span class="label label-success">soldé</span>';}
