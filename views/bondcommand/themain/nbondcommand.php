...
<div class="panel panel-default">
  <div class="panel-heading">
    <h4 class="panel-title"><i class="fa fa-shopping-cart"></i>&nbsp;&nbsp;Gestionnaire de Bonds</h4>
  </div>

  <form class="form-horizontal" action="<?= Yii::$app->request->baseUrl.'/'.md5("bondcommand_themain")?>" id="nventesimpleForm" name="nventesimpleForm" method="post">
    <!-- DEBUT PANEL BODY -->
      ...
      <fieldset>
				<legend><h4><span class="glyphicon glyphicon-hand-right">&nbsp;</span>Moyen de Paiement</h4></legend>
			</fieldset>
			    ...
			    <div class="modal-dialog">
			        <div class="modal-content">
			            ...
			            <div class="modal-footer">
			                <a href="javascript:;" type="button" onclick="document.getElementById('action_key').value='<?= md5("enrgbondcommand") ?>'; document.getElementById('action_on_this').value='<?= md5("1") ?>'; document.getElementById('nventesimpleForm').submit();" class="btn btn-circle btn-success"><i class="glyphicon glyphicon-saved"></i>&nbsp;Oui</a>
...
<?php require_once('script/nbondcommand_js.php'); ?>
